                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="active"><a href="<?= site_url('range'); ?>"><i class="fa fa-circle-o"></i> Date Range </a></li>
                        </ul>
                    </li>
            ...
            <section class="content">
                <div class="box">
                    <div class="box-header">
                        ...
                        <form id="form1" method="POST" action="<?= site_url('range/report') ?>" enctype="multipart/form-data">
                            <div class="form-row">
                                <div class="col-md-2">
                                    <label>Date Start</label>
                                    <div class="input-group date">
                                        <input value="<?= $dateStart ?>" type="text" class="form-control" name="dateStart" id="datepicker" />
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="input-group date">
                                        <input value="<?= $dateFinish ?>" type="text" class="form-control" name="dateFinish" id="datepickeri" />
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                    </div>
                    ...
                    <!-- report -->
                    <?php
                    $this->load->view('report/range_print');
                    ?>
                </div>
                <!-- /.box -->
            </section>
